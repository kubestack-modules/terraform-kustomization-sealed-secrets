...
This module installs Sealed-secrets on Kubernetes.
...
The module bundles an upstream release of Sealed-secrets and makes it fully configurable with Kustomizations set as input attributes.
...
module "example_$module_name" {
  ...
  source  = "kubestack-modules/sealed-secrets/kustomization"
